...
namespace wpfapp.bu.sketch.action.slot
{
    ...
    /// 绘制中心点直槽口
    /// </summary>
    public class CreateSketchSlotCenterLineAction : SwSketchEditActionBase
    {
        #region Fields
        #endregion
        ...
        public CreateSketchSlotCenterLineAction(object oInVo) : base(oInVo)
        {
        ...
        protected override RespVo onExecute()
        {
            ...
            // 绘制图形
            skeMgr.CreateSketchSlot((int)swSketchSlotCreationType_e.swSketchSlotCreationType_center_line, oInVo.SlotLengthType, oInVo.Width / 1000,
