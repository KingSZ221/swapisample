...
namespace wpfapp.bu.usecase.vo
{
    public class SwUseCaseStepItem
    {
        ...
        internal void addCmd(SwUseCaseStepCmdItem useCaseStepCmdItemNew)
        {
            this.CmdInfos.Add(useCaseStepCmdItemNew);
        }

        internal void removeAllCmd()
        {
            this.CmdInfos.Clear();
        }

        internal void updateCmd(SwUseCaseStepCmdItem useCaseStepCmdItem, SwUseCaseStepCmdItem useCaseStepCmdItemUpdate)
        {
            useCaseStepCmdItem.copyFrom(useCaseStepCmdItemUpdate);
        }

        internal bool copyCmd(SwUseCaseStepCmdItem useCaseStepCmdItem)
        {
        ...
        internal void removeCmd(SwUseCaseStepCmdItem useCaseStepCmdItem)
        {
            this.CmdInfos.Remove(useCaseStepCmdItem);
        }

        internal bool moveUpDownCmd(SwUseCaseStepCmdItem useCaseStepCmdItem, bool bMoveDown)
        {
            int iIndex = this.CmdInfos.IndexOf(useCaseStepCmdItem);
            if (iIndex >= 0)
            {
        ...
        internal void addSubStep(SwUseCaseStepItem useCaseStepSubItemNew)
        {
            this.SubSteps.Add(useCaseStepSubItemNew);
        }

        internal void removeAllSubStep()
        {
            this.SubSteps.Clear();
        }

        internal void updateSubStep(SwUseCaseStepItem useCaseSubStepItem, SwUseCaseStepItem useCaseStepSubItemUpdate)
        {
            useCaseSubStepItem.copyFrom(useCaseStepSubItemUpdate);
        }

        internal bool copySubStep(SwUseCaseStepItem useCaseSubStepItem)
        {
        ...
        internal void removeSubStep(SwUseCaseStepItem useCaseSubStepItem)
        {
            this.SubSteps.Remove(useCaseSubStepItem);
        }

        internal bool moveUpDownSubStep(SwUseCaseStepItem useCaseSubStepItem, bool bMoveDown)
        {
            int iIndex = this.SubSteps.IndexOf(useCaseSubStepItem);
            if (iIndex >= 0)
            {
