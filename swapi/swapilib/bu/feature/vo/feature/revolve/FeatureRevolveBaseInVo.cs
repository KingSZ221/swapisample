...
namespace swapilib.bu.feature.vo.feature.revolve
{
    public class FeatureRevolveBaseInVo
    {
        ...
        [Category("旋转结束条件")]
        [PropertyOrder(6)]
        public swEndConditions_ext Dir1Type { get; set; } = 0;
        ...
        [Category("旋转结束条件")]
        [PropertyOrder(7)]
        public swEndConditions_ext Dir2Type { get; set; } = 0;
        ...
        [Category("旋转结束条件")]
        [PropertyOrder(8)]
        public double Dir1Angle { get; set; } = 180;
        ...
        [Category("偏移")]
        [PropertyOrder(12)]
        public double OffsetDistance1 { get; set; } = 0;
        ...
        [Category("偏移")]
        [PropertyOrder(13)]
        public double OffsetDistance2 { get; set; } = 0;
        ...
        [Category("薄壁类型")]
        [PropertyOrder(14)]
        public swThinWallType_ext ThinType { get; set; } = swThinWallType_ext.swThinWallOneDirection;
        ...
        [Category("薄壁类型")]
        [PropertyOrder(15)]
        public double ThinThickness1 { get; set; } = 10;
