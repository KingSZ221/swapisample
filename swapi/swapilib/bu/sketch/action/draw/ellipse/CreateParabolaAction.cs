...
namespace swapilib.bu.sketch.action.draw.ellipse
{
    ...
    public class CreateParabolaAction : SwSketchDrawActionBase
    {
        ...
        public CreateParabolaAction() : base()
        {
        ...
        {
            // 获取绘制参数
            CreateParabolaInVo oInVo = this.actionInVo<CreateParabolaInVo>();
            ...
            // 绘制图形
            var sketchSegment = skeMgr.CreateParabola(oInVo.XFocus / 1000, oInVo.YFocus / 1000, oInVo.ZFocus / 1000,
            ...
            return RespVoLogExt.genOk("绘制抛物线成功");
        }
    }
}
