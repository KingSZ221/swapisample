...
using swapilib.bu.sketch.vo.draw;
using swapilib.basic.io;

namespace swapilib.bu.sketch.action.draw
{
    /// <summary>
    /// 草图绘制操作基类
    /// </summary>
    public class SwSketchDrawActionBase : SwSketchActionBase
    {
        #region Fields
        #endregion
        ...
        public override RespVo execute()
        {
            ...
            // 获取绘制参数
            SketchDrawInVoBase oInVo = this.actionInVo<SketchDrawInVoBase>();
