...
namespace swapilib.bu.assembly.action
{
    /// <summary>
    /// 装配体操作基类
    /// </summary>
    public class SwAssemblyActionBase : SwCmdActionBase
    {
        #region Fields
        ...
        protected AssemblyDoc curAssemlyDoc
        {
            get
            {
                if (_curDoc == null)
        ...
        protected RespVo priCheckPartDoc(ref ModelDoc2 doc)
        {
            ...
            {
                return RespVoLogExt.genError("当前打开的不是装配体");
            }
